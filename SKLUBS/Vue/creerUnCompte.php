...
<section>
	...
	<div class="inscription">
		...
		<form class="form1" name="form" method="post" action="../Modele/creationCompteBis.php" onsubmit="return validateEmail()">
			...
			<div class="champnom ligne2">
				...
				<input type="text" name="Email"  id="mail" required/><br>
			</div>
